...
def main(args):
    ...
    while epoch < args.max_epoch:
        ...
        for batch_idx, data in enumerate(train_loader, 1):
            ...
            log_ll_1 = (log_ll_[0] + log_det).mean()
            log_ll_2 = (log_ll_[1] + log_det).mean()
            log_ll_3 = (log_ll_[2] + log_det).mean()

            log_ll = (log_ll_1 + log_ll_2 + log_ll_3)/3
        ...
        with torch.no_grad():
            ...
            utils.save_image(utils.make_grid(samples),
                '/csehome/verma.43/epoch{epoch}.png')
